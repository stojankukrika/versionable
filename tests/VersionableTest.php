...
use StojanKukrika\Versionable\Version;
use StojanKukrika\Versionable\VersionableTrait;
...
class VersionableTest extends VersionableTestCase
{
    ...
    public function testVersionableRelation()
    {
        ...
        $user->name = "Stojan Kukrika";
        $user->email = "stojan.kukrika@test.php";
        $user->password = "12345";
    ...
    public function testRetrievePreviousVersionExists()
    {
        ...
        $this->assertEquals( "Stojan Kukrika", $user->previousVersion()->getModel()->name );
    }
    ...
    public function testCanRevertVersion()
    {
        ...
        $newUser = TestVersionableUser::find( $user_id );
        $this->assertEquals( "Stojan Kukrika", $newUser->name );
    }
    ...
    public function testCanRevertSoftDeleteVersion()
    {
        ...
        $newUser = TestVersionableSoftDeleteUser::find( $user_id );
        $this->assertEquals( "Stojan Kukrika", $reverted->name );
        $this->assertEquals( "Stojan Kukrika", $newUser->name );
    }
    ...
    public function testGetVersionModel()
    {
        ...
        $this->assertEquals( "Stojan Kukrika", $user->getVersionModel( 1 )->name );
    ...
    public function testDiffSpecificVersions()
    {
        ...
        $this->assertEquals( "Stojan Kukrika", $diff["name"] );
        $this->assertEquals( "stojan.kukrika@test.php", $diff["email"] );
    ...
    public function testKeepMaxVersionCount()
    {
        ...
        $model->email = "stojan.kukrika@test.php";
        $model->password = "foo";
        $model->name = $name_v1 ;
        $model->save();
